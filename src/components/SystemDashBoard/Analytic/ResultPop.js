...
export default function ResultPop({ open, setOpen }) {
              ...
              >
                <Dialog.Panel className="relative px-10 pb-8 bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-2 sm:max-w-xl sm:w-full ">
                  <div className="bg-white ">
                    ...
                    <div className="grid grid-cols-2 gap-5 w-full m-auto mt-10">
                      <div className={`w-full h-fit bg-blue-600 `}>adsf</div>
                      <div className="w-full h-fit bg-red-600">daf</div>
                    </div>
                  </div>
